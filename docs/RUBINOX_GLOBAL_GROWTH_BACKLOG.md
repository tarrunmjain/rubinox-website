...
Date: 2026-06-29
Scope: master backlog for future Rubinox website work.

Priority definitions:

- P0 = critical foundation
- P1 = high impact growth
- P2 = authority and expansion
- P3 = premium polish
...
| P3-006 | Interactive tools if feasible | Content roadmap | Technical resources | P3 | Medium | High | Medium | High | High | No | Verified formulas | Pending | Experimental tools | Avoid inaccurate calculators |
| P4-001 | On-Page.ai targeted scans | Tooling roadmap | SEO tooling | P4 | Medium | Medium | None | Low | Medium | Yes | Paid/credit approval | Optional | Tooling | Use only for targeted scans |
| P4-002 | Semrush competitor scans | Tooling roadmap | SEO tooling | P4 | Medium | Medium | None | Low | Medium | Yes | Subscription approval | Optional | Tooling | Competitor and keyword research |
| P4-003 | Codex SEO advanced audits | Tooling roadmap | SEO tooling | P4 | Medium | Medium | None | Low | Low | No | Core roadmap | Optional | Tooling | Use after local QA is stable |
| P4-004 | AI answer visibility testing | AEO roadmap | AEO/LLMO | P4 | Medium | High | None | Low | Medium | No | AEO blocks | Optional | AI visibility | Perplexity, Gemini, ChatGPT query checks |
| P4-005 | LLMO experiments | AEO roadmap | AEO/LLMO | P4 | Medium | High | Low | Low | Medium | No | llms.txt workflow | Optional | AI visibility | Run only after core pages stabilize |
